...
::: {}
I am a Senior at SUNY Geneseo majoring in Business Administration with a minor in Data Analytics.
view myself as an **applied economist** with interest in the field of **environmental economics** and a particular focus on **climate change policy**. Methodologically, I make use of **econometric/machine learning methods and data science tools** to conduct empirical analysis. I also use computational methods to solve **integrated assessment models (IAM) of climate change** as well as theoretical economic models, such as **dynamic contracts**.


My **research** focuses on the correlation between **debt one year out of college** versus **incomes one year out of college**. 
